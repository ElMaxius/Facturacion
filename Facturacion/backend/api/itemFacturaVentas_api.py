...
from modelos.itemFacturaVentas_api import ItemFacturaVentasApi, ItemFacturaVentas, ItemFacturaVentasLista
...
@itemFacturaVentas_api.get('/{desde}/{hasta}', response_model=list[ItemFacturaVentasLista])
